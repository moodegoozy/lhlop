...
import { Users, Mail, Phone, MapPin, Globe, MessageCircle } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <a href="#" className="w-10 h-10 bg-white/10 hover:bg-red-600 rounded-lg flex items-center justify-center transition-colors">
                <YoutubeIcon />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#teachers" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                  <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span>
                  {t('teachers')}
                </Link>
              </li>
              ...
              <li>
                <Link href="/join" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                  <span className="w-1.5 h-1.5 bg-blue-500 rounded-full"></span>
                  {t('join_as_teacher')}
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-gray-400">
                ...
                <span className="text-sm">{t('platform_address')}</span>
              </li>
              <li className="flex items-center gap-3 text-gray-400">
                <Mail className="w-5 h-5 text-blue-400 flex-shrink-0" />
                <span className="text-sm">support@lhloop.com</span>
              </li>
              <li className="flex items-center gap-3 text-gray-400">
